        ...
        <>
            <div className="col">
                <button className="btn btn-primary btn-block btn-lg mt-1" type="submit">
                    Login
                    <svg class="bi bi-box-arrow-in-right ml-2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <>
            ...
            <div className="col">
                <button className="btn btn-primary btn-block btn-lg mt-1" type="submit" >
                    Register&nbsp;
                    <svg class="bi bi-archive ml-2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
